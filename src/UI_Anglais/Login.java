...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonChangerLangue.setText("Connexion en français");
            ...
            if (connexion_autorisee) {
                ...
                while (type_User.next()) {
                    ...
                    if (metier_user.equals("MEDECIN")) {
                        ...
                        new UI.Acceuil_Radiologue(objet_Courant).setVisible(true); //ouvre la fenetre l'accueil radiologue
                        ...
                        if (type_User.getString("metier").equals("MANIPULATEUR_RADIO")) {
                            ...
                            new UI.Acceuil_ManipRadio(objet_Courant).setVisible(true);
                            this.dispose();
                        } else {
                            if (type_User.getString("metier").equals("SECRETAIRE_MEDICALE")) {
                                ...
                                new UI.Acceuil_Sec(objet_Courant).setVisible(true);
                                this.dispose();
                            }
                        }
                    }
