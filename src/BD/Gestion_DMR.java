...
public class Gestion_DMR {
    ...
    /**
     * Permet de récupérer la liste des examens d'un DMR, en indiquant le nom
     * d'usage du patient
     */
    ...
    public static ArrayList<DMR> recuperer_DMRs(String id_recherche) {
        ...
        try {
            ...
            while (resultset.next()) {
                ...
                //creation liste examens
                ArrayList<Examen> examens = recuperer_Examens(id_recherche);
                //fin creation examens
                //ArrayList<DMR> DMRs = recuperer_DMRs(id_recherche, connexion);
                liste_DMRs.add(new DMR(id_dmr, patient, examens, historique_modifications));
    ...
    /**
     * A partir d'un dmr passé en paramètre, crée ce dmr dans la BD Dans un
     * premier temps, on regarde si le patient existe et si il a un dmr
     */
