 ...
 * @author camin
 */
public class Crea_RapportTom extends javax.swing.JFrame {

    /**
     * Creates new form Acceuille_Radiologue
     */
    public Crea_RapportTom() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Crea_RapportTom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Crea_RapportTom().setVisible(true);
            }
        });
    }
